 ...
 */
// generated on 2016-10-05 using generator-openmrs-owa 0.3.0
'use strict';
...
const THIS_APP_ID = 'modulemanagement';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/modulesmanagement/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/modulesmanagement.js`,
	  css: `${__dirname}/app/css/modulesmanagement.css`,
	  vendor : [
